                        ...
                        >
                            ...
                            <div>
                                ...
                                <div className="flex gap-4 mb-6">
                                    <button
                                        className="w-full px-4 py-3 text-center text-gray-100 bg-blue-800 border border-transparent dark:border-gray-700 hover:border-pink-600 hover:text-white hover:bg-pink-600 rounded-xl"
                                    >
                                        Buy now
                                    </button>
                                </div>
