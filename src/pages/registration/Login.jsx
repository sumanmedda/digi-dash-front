            ...
            <div className="login_Form bg-blue-50 px-1 lg:px-8 py-6 border border-blue-100 rounded-xl shadow-md">
                ...
                <div className="mb-3">
                    <input
                        ...
                        className='bg-blue-50 border border-blue-200 px-2 py-2 w-96 rounded-md outline-none placeholder-blue-400'
                    />
                </div>
                ...
                <div className="mb-5">
                    <button
                        type='button'
                        className='bg-blue-800 hover:bg-pink-600 w-full text-white text-center py-2 font-bold rounded-md '
                    >
                        Login
                    </button>
                </div>
