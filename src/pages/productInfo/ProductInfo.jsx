                        ...
                        <div className="w-full px-4 md:w-1/2">
                            <div className="lg:pl-20">
                                ...
                                <div className="flex flex-wrap items-center mb-6">
                                    ...
                                    <button
                                        className="w-full px-4 py-3 text-center text-white bg-blue-400 border border-blue-800  hover:border-pink-600 hover:bg-pink-600 hover:text-gray-100 rounded-xl"
                                    >
                                        Add to cart
                                    </button>
                                </div>
